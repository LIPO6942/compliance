    ...
    subCategories: [
      {
        ...
        icon: 'FileText',
        tasks: [
          { id: 'task-cadre-1', name: "Élaborer un manuel interne de procédures de Lutte contre le Blanchiment d'Argent et le Financement du Terrorisme (LBA/FT).", completed: false },
    ...
    subCategories: [
      {
        ...
        icon: 'FileSearch',
        tasks: [
            { id: 'task-kyc-1', name: "Vérifier l'identité complète du souscripteur, de l'assuré et du bénéficiaire (s'ils sont différents), en se basant sur des documents officiels et des sources fiables et indépendantes.", completed: false },
            { id: 'task-kyc-2', name: 'Exiger les copies certifiées conformes des documents d\'identification originaux (carte d\'identité nationale, passeport, carte de séjour), avec la signature du chargé de souscription et la mention "conforme à l\'original".', completed: false },
            ...
            { id: 'task-kyc-6', name: "S'assurer que la fiche KYC est dûment remplie et signée par le client, et qu'elle contient toutes les informations obligatoires.", completed: false },
            ...
            { id: 'task-kyc-12', name: "Exiger des justificatifs pour les demandes de rachat anticipé, d'avance, de rachat ou de transfert, ainsi que pour les modifications des données client.", completed: false },
      ...
      },
      {
        ...
        icon: 'UserCog',
        tasks: [
            { id: 'task-be-1', name: "Identifier la ou les personnes physiques détenant directement ou indirectement 20% ou plus du capital ou des droits de vote.", completed: false },
      ...
      },
      {
        ...
        icon: 'Award',
        tasks: [
            { id: 'task-ppe-1', name: "Déterminer si le client, les bénéficiaires effectifs ou leurs proches sont des personnes politiquement exposées (PPE).", completed: false },
    ...
    subCategories: [
      {
        ...
        icon: 'Filter',
        tasks: [
            { id: 'task-filtrage-1', name: "Vérifier systématiquement la présence des clients et des bénéficiaires effectifs dans les listes de sanctions nationale (Commission Nationale de Lutte Contre le Terrorisme - CNLCT) et onusienne (Nations Unies - NU).", completed: false },
    ...
    subCategories: [
      {
        ...
        icon: 'Eye',
        tasks: [
            { id: 'task-detection-1', name: "Mettre en place un dispositif de détection des opérations ou transactions suspectes ou inhabituelles basé sur l'identification, la classification, le suivi et le contrôle des risques.", completed: false },
            ...
            { id: 'task-detection-5', name: "Traiter les alertes générées par le système, vérifier leur pertinence et demander des compléments d'information si nécessaire.", completed: false },
      ...
      },
      {
        ...
        icon: 'MailWarning',
        tasks: [
            { id: 'task-ds-1', name: "Procéder à l'analyse et, le cas échéant, à la Déclaration de Soupçon (DS) à la Commission Tunisienne des Analyses Financières (CTAF).", completed: false },
            { id: 'task-ds-2', name: "Si le soupçon est en rapport avec le financement du terrorisme, effectuer également une déclaration à la CNLCT.", completed: false },
    ...
    subCategories: [
      {
        ...
        tasks: [
            ...
            { id: 'task-ci-2', name: "Intégrer le contrôle du dispositif LBA/FT dans le programme de travail des missions d'audit interne des départements concernés.", completed: false },
      ...
      },
      {
        ...
        tasks: [
            ...
            { id: 'task-reporting-2', name: "Soumettre au CGA le rapport d'audit interne sur l'évaluation du système de contrôle interne relatif à la LBA/FT, son efficacité et son adéquation avec le degré d'exposition de la société au risque.", completed: false },
            { id: 'task-reporting-3', name: "Communiquer au CGA les statistiques des Déclarations de Soupçon (DS) effectuées à la CTAF (nombre, nature, sort, montant total, catégories d'assurances concernées, circuits de distribution utilisés).", completed: false },
            { id: 'task-reporting-4', name: "Informer le CGA du nombre, de la nature et des montants des contrats gelés.", completed: false },
            { id: 'task-reporting-5', name: "Adresser au CGA un rapport annuel élaboré par le responsable de la conformité, résumant les résultats de ses travaux en matière de LBA/FT, évaluant la conformité du dispositif, les connaissances des employés, et les sessions de formation réalisées.", completed: false },
    ...
    subCategories: [
       {
        ...
        icon: 'BookOpen',
        tasks: [
          { id: 'task-formation-1', name: "Planifier et assurer une formation continue au profit du personnel, notamment ceux chargés des opérations de souscription et d'indemnisation, au moins une fois par an.", completed: false },
    ...
    subCategories: [
      {
        ...
        tasks: [
            ...
            { id: 'task-doc-2', name: "Conserver l'ensemble des documents et informations recueillies dans le dossier client (y compris pièces d'identité et contrats) sur support électronique ou matériel pendant une durée minimale de 10 ans à compter de la date de fin du contrat d'assurance.", completed: false },
