      ...
      <DialogContent className="max-w-xl max-h-[92vh] overflow-y-auto p-0 border-none bg-transparent shadow-none">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-3.5">
            {/* Aperçu du Titre Généré Automatiquement */}
              ...
              <div className="p-3 rounded-2xl bg-amber-500/10 dark:bg-slate-800/80 border border-amber-300/60 dark:border-amber-700/50 flex items-center justify-between gap-3 shadow-xs">
                <div className="flex items-center gap-2.5 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    {isGeneratingTitle && (
                      <span className="text-[9px] font-bold text-amber-700 dark:text-amber-300 italic animate-pulse block mb-0.5">
                        Génération du titre en cours...
                      </span>
                    )}
                    <p className="text-xs font-black text-slate-900 dark:text-white truncate">
                      {content.trim()
                        ? (autoGeneratedTitle || "Génération du titre en cours...")
                        : "Rédigez le texte de votre mémo pour générer le titre automatiquement..."}
                    </p>
                  </div>
                </div>
