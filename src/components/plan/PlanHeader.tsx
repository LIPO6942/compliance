        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <Button
              ...
              className="h-14 w-14 p-0 rounded-2xl border-2 border-slate-100 dark:border-slate-800 hover:bg-slate-50 transition-all shadow-xl shadow-slate-200/20 group flex items-center justify-center shrink-0"
            >
              <RefreshCw className={cn("h-5 w-5 text-emerald-500 group-hover:rotate-180 transition-transform duration-500", isSyncing && "animate-spin")} />
            </Button>

            <Button onClick={onAddCategory} className="h-14 px-8 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-black uppercase text-[10px] tracking-widest shadow-2xl shadow-indigo-600/30 border-none transition-all hover:scale-[1.02] active:scale-95 whitespace-nowrap">
